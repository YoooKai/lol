...
var loadChampions = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, data, championData, key, champion;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          data = _context.sent;
          championData = data.data; // Limpiar la lista de campeones
          champions = [];

          // Crear y agregar cada campeón al array
          for (key in championData) {
            champion = new _Champion.default(championData[key]);
        ...
        case 13:
          ...
          console.error("Error cargando los campeones:", _context.t0);
        case 16:
        case "end":
...
var showChampionList = function showChampionList() {
  ...
  champions.forEach(function (champion) {
    championList.innerHTML += "\n            <div class=\"card\" style=\"position: relative;\">\n                <img src=\"https://ddragon.leagueoflegends.com/cdn/img/champion/loading/".concat(champion.image, "\">\n                <br>\n                <strong>").concat(champion.name, "</strong>\n                <p class=\"title\">").concat(champion.title, "</p><br>\n                <div class=\"types\">\n                    Roles: ").concat(champion.roles.join(', '), "\n                </div>\n                <div class=\"blurb\">\n                    ").concat(champion.blurb, " \n                </div>\n            </div>\n        ");
  });
};
...
//# sourceMappingURL=/lol/js.00a46daa.js.map